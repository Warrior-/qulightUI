...
if Qulight["actionbar"].enable then
	...
	AnchorQuBar4:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 325)
	CreateAnchor(AnchorQuBar4, "Move Bar4", (buttonsize * mbWidth) + (buttonspacing * (mbWidth-1)), buttonsize)
	...
	CreatePanel(QuBar5, 20, 20, "BOTTOM", minimaplol, "TOP", -65, 19)
	QuBar5:SetWidth(20)
	QuBar5:SetFrameStrata("BACKGROUND")
	QuBar5:SetFrameLevel(2)
	QuBar5:SetAlpha(0)
	QuBar5:SetScale(0.65)
	
	AnchorQuBar6 = CreateFrame("Frame","Move_Bar6",UIParent)
	AnchorQuBar6:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 3)
	...
	AnchorQuBar7:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 40)
