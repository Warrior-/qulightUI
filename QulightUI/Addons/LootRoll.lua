...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(Qulight["media"].font, 10, "OUTLINE")
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture(Qulight["media"].texture)
	...
	bind:SetFont(Qulight["media"].font, 10, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(Qulight["media"].font, 10, "OUTLINE")
