...
function addon:Style()
	...
	ge:SetPoint("RIGHT", p, "RIGHT", 0, -10)
	ge:SetWidth(width)
	ge:SetHeight(height)
	framechat(ge)
	...
	t:SetPoint("RIGHT", ge, "RIGHT", 0, -10)
	t:SetWidth(width)
	t:SetHeight(height)
	framechat(t)
