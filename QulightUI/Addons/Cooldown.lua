if not Qulight["cooldown"].enable == true then return end
...
local FONT_FACE = Qulight["media"].pxfont --what font to use
local FONT_SIZE = 17 --the base font size to use at a scale of 1
local MIN_SCALE = 0.5 --the minimum scale we want to show cooldown counts at, anything below this will be hidden
local MIN_DURATION = 2.5 --the minimum duration to show cooldown text for
local EXPIRING_DURATION = 0 --the minimum number of seconds a cooldown must be to use to display in the expiring format
